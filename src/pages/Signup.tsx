    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-lg border border-zinc-200 bg-white p-6">
        ...
        <form
          ...
          onSubmit={async (e) => {
            ...
            try {
              ...
              // Try to navigate; if confirmation is required, user will still be signed out until they confirm.
        ...
        <div className="mt-4 text-sm text-zinc-600">
          Already have an account? <Link to="/login" className="text-zinc-900 underline">Login</Link>
        </div>
      </div>
    </div>
  );
